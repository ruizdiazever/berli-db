...
-- SYSTEM PERMISSION TO (COMPANY, STAFF, CLIENT, EMPLOYEE)
CREATE TABLE permissions."system_entity" (
    id uuid DEFAULT uuid_generate_v4() NOT NULL CONSTRAINT permissions_user_pkey PRIMARY KEY,
